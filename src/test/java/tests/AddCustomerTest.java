...
public class AddCustomerTest {
    ...
    public void userShouldBeAbleToAddCustomer(String userName, String password,String fullName,String companyName,String emailAddress,String phoneNumber, String streetAddress, String city, String country,String state, String zip) throws InterruptedException {
     driver = BrowserFactory.init();
        ...
        listCustomerPage.validateInsertedNamePageAndDelete();
